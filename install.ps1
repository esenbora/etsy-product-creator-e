...
# Kullanim:
#   iwr -useb https://raw.githubusercontent.com/esenbora/etsy-product-creator-e/main/install.ps1 | iex
# Ozel hedef:
...
$TARGET = if ($env:TARGET) { $env:TARGET } else { Join-Path $HOME "etsy-product-creator-e" }
